...
const RepoUrl='https://github.com/nirre7/ignite-expo-diff-purge'
            ...
            return [
                ...
                ...R.pipe(
                    R.map(idx => {
                        ...
                        return isBig
                            ? `[->${toRelease}](${RepoUrl}/compare/release/${fromRelease}..release/${toRelease}) [ignite core](https://github.com/infinitered/ignite/compare/v${fromRelease}...v${toRelease})`
